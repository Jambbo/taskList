...
public class TestConfig {
    ...
    public JwtProperties jwtProperties(){
        ...
        jwtProperties.setSecret("bGZrZHNuYWxramduc2ZqZ2FubGpubGlqbmZhd2VpcmZzZG5qc2FkbGY");
    ...
    public MinioClient minioClient(){
        return Mockito.mock(MinioClient.class);// Мокито делает объект типа миниоклиент и его нам возвращает
    }
    ...
    @Bean
    @Primary // чтобы бин использовался внутри test scope
