...
public class TaskRepositoryImpl implements TaskRepository {
    ...
    //JDBC
        // JDBC пишется руками и потом мэпится на объекты-строки
    ...
    public Optional<Task> findById(Long id) {
        try{
            ...
            try(ResultSet rs = statement.executeQuery()){
                return Optional.ofNullable(TaskRowMapper.mapRow(rs)); //TaskRowMapper - это маппер который будет принимать
    ...
    public void assignToUserById(Long taskId, Long userId) {
        try{
            ...
            throw new ResourceMappingException("Error while assign to user by id.");
        }
    }
