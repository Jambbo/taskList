...
// Мы хотим проходить несколько раз по ResultSet по этому необходимо передать еще 2 параметра
            PreparedStatement statement = connection.prepareStatement(FIND_BY_ID,
                    ResultSet.TYPE_SCROLL_INSENSITIVE,
                    ResultSet.CONCUR_READ_ONLY); // С помощью этих двух дополнительных параметров мы можем проходить по ResultSet и взад и вперед и возвращаться в начало
// Эти 2 доп. параметра сверху нам нужны для того чтобы мы могли прочитать сначала список весь, потом список ролей, и потом юзеров
