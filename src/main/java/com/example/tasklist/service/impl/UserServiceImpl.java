...
// и это достаточно экономно, т.к. запросы в бд бывают большие
    ...
    // когда мы обращаемся к программе, к этому методу, спринг проверяет есть ли в кеше(редисе) по данному ключу в данном value что-нибудь, нет - запрос к бд, да - возвращаются из кеша данные
